  ...
  return (
    <div className="space-y-8">
      ...
      <section className="text-center space-y-4">
        <img src="/placeholder.svg" alt="Great Wall of China" className="w-full h-64 object-cover" />
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            ...
            <CardContent>
              <img src="/placeholder.svg" alt="Traditional Clothing" className="w-full h-32 object-cover" />
          ...
          <Card>
            ...
            <CardContent>
              <img src="/placeholder.svg" alt="Festivals" className="w-full h-32 object-cover" />
          ...
          <Card>
            ...
            <CardContent>
              <img src="/placeholder.svg" alt="Cuisine" className="w-full h-32 object-cover" />
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-2">
          <Card>
            ...
            <CardContent>
              <img src="/placeholder.svg" alt="Ancient Dynasties" className="w-full h-32 object-cover" />
          ...
          <Card>
            ...
            <CardContent>
              <img src="/placeholder.svg" alt="Key Historical Events" className="w-full h-32 object-cover" />
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            ...
            <CardContent>
              <img src="/placeholder.svg" alt="The Great Wall of China" className="w-full h-32 object-cover" />
          ...
          <Card>
            ...
            <CardContent>
              <img src="/placeholder.svg" alt="The Forbidden City" className="w-full h-32 object-cover" />
          ...
          <Card>
            ...
            <CardContent>
              <img src="/placeholder.svg" alt="Terracotta Army" className="w-full h-32 object-cover" />
